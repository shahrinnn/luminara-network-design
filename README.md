...
## Overview
This project is a Cisco Packet Tracer multi-site network implementation for The Crystal Realm of LUMINARA. It connects six routed LANs using VLSM subnetting, RIP v2, static routing, DHCP relay, DNS, Web, and Email services.

## Project Goals
- Design a scalable multi-site network using VLSM.
- Connect six LANs using routers, switches, and WAN links.
- Configure RIP v2 and required static/floating static routes.
...
| DHCP Server | 15.1.43.13 | Assigns IP addresses to remote LANs |
...
## Files Included
- Cisco Packet Tracer `.pkt` project file
- Final PDF report
